...
\midrule
SS-A    & 0.943 & \textbf{0.999} & 0.946 & 0.944 & 0.944 \\
SS-B    & 0.799 & \textbf{1.000} & 0.604 & 0.604 & 0.942 \\
SS-C    & 0.869 & \textbf{1.000} & 0.889 & 0.900 & 0.885 \\
SS-D    & 0.481 & \textbf{0.706} & 0.547 & 0.530 & 0.554 \\
Apache  & 0.978 & \textbf{1.000} & 0.983 & 0.967 & 0.989 \\
redis   & 0.679 & \textbf{1.000} & 0.654 & 0.654 & 0.680 \\
storm   & \textbf{1.000} & \textbf{1.000} & \textbf{1.000} & \textbf{1.000} & \textbf{1.000} \\
pom3d   & 0.830 & \textbf{0.920} & 0.805 & 0.783 & 0.870 \\
auto93  & 0.436 & \textbf{0.500} & 0.571 & 0.442 & 0.443 \\
pom3a   & 0.799 & 0.871 & 0.723 & 0.736 & \textbf{0.905} \\
\midrule
\textbf{Average} & 0.781 & \textbf{0.900} & 0.772 & 0.756 & 0.821 \\
\bottomrule
\end{tabular}
\end{table}

\begin{table}[h]
\caption{Mean Pareto Recall across 3 seeds (higher is better). Greedy dominates because it successfully finds a single extreme point on tiny true Pareto fronts, but fails to provide diverse trade-offs.}
\label{tab:pareto-recall}
\begin{tabular}{lccccc}
\toprule
\textbf{Dataset} & \textbf{Random} & \textbf{Greedy} & \textbf{MOTPE} & \textbf{NSGA-II} & \textbf{HSEvo} \\
\midrule
SS-A    & 0.000 & \textbf{0.667} & 0.000 & 0.000 & 0.000 \\
SS-B    & 0.000 & \textbf{1.000} & 0.000 & 0.000 & 0.000 \\
SS-C    & 0.000 & \textbf{0.500} & 0.000 & 0.000 & 0.000 \\
SS-D    & 0.022 & \textbf{0.067} & 0.022 & 0.022 & 0.022 \\
Apache  & 0.000 & \textbf{1.000} & 0.000 & 0.000 & 0.000 \\
redis   & 0.000 & \textbf{1.000} & 0.000 & 0.000 & 0.000 \\
storm   & 0.000 & \textbf{1.000} & 0.000 & 0.000 & 0.000 \\
pom3d   & 0.000 & \textbf{0.429} & 0.000 & 0.000 & 0.000 \\
auto93  & 0.000 & \textbf{0.154} & 0.000 & 0.000 & 0.000 \\
pom3a   & 0.000 & \textbf{0.500} & 0.000 & 0.000 & 0.000 \\
\midrule
\textbf{Average} & 0.002 & \textbf{0.632} & 0.002 & 0.002 & 0.002 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{figure}[h]
  ...
  \caption{Zero-Shot Warm-Start Analysis (Average HV vs.\ Active-Learning Step, pop\_size=6, 3 seeds). HSEvo (purple) consistently outperforms MOTPE and NSGA-II from $t=1$ onward.}
  \label{fig:warm_start}
\end{figure}

The \textbf{Zero-Shot Warm-Start Analysis} (Figure~\ref{fig:warm_start}) shows that HSEvo achieved an average final HV of 0.821, outperforming MOTPE (0.772) and NSGA-II (0.756). From the very first step ($t=1$), HSEvo outperforms both statistical solvers and widens its lead monotonically through $t=10$, demonstrating a \emph{Zero-Shot Warm-Start Advantage} from the LLM's semantic prior knowledge.

\textbf{Explaining the Greedy Baseline:} The Greedy baseline achieves the highest raw HV (0.900), jumping to $\sim$0.9 within 2 steps. This is a known artifact: Greedy optimizes a single objective and instantly finds an extreme boundary point that dominates a large rectangular volume. As shown in Table~\ref{tab:pareto-recall}, Greedy's average Pareto Recall is artificially high (0.632) because the true global Pareto front for many of these datasets is extremely small (e.g., 1 to 3 points). Greedy successfully finds this single optimal point, yielding $100\%$ recall, but it suffers from total \textbf{objective diversity collapse}. It only ever finds one solution, making it useless for practitioners who need diverse trade-off solutions across multiple objectives.
...
\item \textbf{Robustness:} Cross-dataset standard deviations were comparable: HSEvo $\sigma=0.184$, Random $\sigma=0.185$, MOTPE $\sigma=0.167$, NSGA-II $\sigma=0.186$, Greedy $\sigma=0.161$. HSEvo maintained competitive variance despite the stochastic nature of LLM generation.
\item \textbf{Explainability:} HSEvo generated fully human-readable Python functions with average McCabe Cyclomatic Complexity $V(G) = 3.67$ (range: 2--6). This metric is asymmetric---it applies only to HSEvo since MOTPE and NSGA-II are black-box solvers that produce no inspectable code. We acknowledge this as a limitation.
\end{itemize}

\section{Discussion}

\subsection{Results and Implications}
The results provide nuanced support for RQ1. HSEvo (mean HV = 0.821) significantly outperforms Random ($p=0.002$) and NSGA-II ($p=0.027$), and achieves comparable performance to MOTPE ($p=0.160$) while producing fully interpretable Python code that MOTPE cannot. The Greedy baseline's apparent superiority (0.900) is misleading---its single-objective optimization inflates HV through diversity collapse rather than genuine multi-objective coverage.
