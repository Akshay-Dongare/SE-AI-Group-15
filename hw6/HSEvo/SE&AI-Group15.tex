...
We initially validated framework feasibility on the Online Bin Packing Problem (BPP), where all three frameworks (HSEvo, ReEvo \cite{reevo2024}, and EoH \cite{eoh2024}) successfully evolved scoring heuristics outperforming static baselines; however, BPP is a theoretical toy problem and all reported results in this paper use real-world MOOT tasks \cite{menzies2024moot}.
